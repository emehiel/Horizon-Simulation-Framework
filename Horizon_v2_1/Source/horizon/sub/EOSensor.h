...
private:
	...
	double th; // Sensor Pitch per pixel in radians
	int hPixels;  // number of pixels on the sensor - horizontal
	int vPixels;  // number of pixels on the sensor - vertical
	int pixels;
