...
//	friend Matrix operator/ ( const double &a, const Matrix &A );
	...
	*/
	...
	/*
	// Calculates the Cumulative Product of the Matrix
	// @param A The input matrix
	// @return A Matrix whos entries represent the cumulative product of the elements of A
	*/
	friend Matrix cumprod(const Matrix &A);
};
