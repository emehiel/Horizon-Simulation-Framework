...
public:
	...
	/**
	 * Copy constructor.
	 * Does NOT copy preceeding nodes.
	 */
	SubsystemNode(const SubsystemNode& other);
...
inline void SubsystemNode::setThreadNum(int threadNum) {
	dependencies.setThreadNum(threadNum); }

inline void SubsystemNode::setDependencies(Dependencies* deps) {
	this->dependencies.setDependencies(deps); }
