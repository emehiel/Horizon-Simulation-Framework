/**
* \file ScriptedScheduleEvaluator.h
* This file contains a class used to evaluate schedules using a 
* LUA function.
* @author Brian Butler
*/

#ifndef SCRIPTEDSCHEDULEEVALUATOR_H
#define SCRIPTEDSCHEDULEEVALUATOR_H
 ...
 * @author Brian Butler
 */
class ScriptedScheduleEvaluator : public virtual ScheduleEvaluator {
private:
	/**
...
public:
	...
	*/
	ScriptedScheduleEvaluator(lua_State* L, string evaluateLUAFcn);

	/**
	* A destructor.
	*/
	~ScriptedScheduleEvaluator();
