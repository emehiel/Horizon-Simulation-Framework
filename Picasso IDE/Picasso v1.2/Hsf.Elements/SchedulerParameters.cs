...
{
    public class SchedulerParameters : HsfElement
    {
        ...
        public override string ToXml()
        {
            ...
            string toReturn = "<" + ElementType + " MaxSchedules=\"" + MaxSchedules + "\" CropTo=\"" + CropTo + "\" SimStep=\"" + SimStep + "\"></" + ElementType + ">";
            return toReturn;
        }
        ...
        public override void FromXml(string source)
        {
            ...
            List<Hashtable> results = parser.Query("SELECT MaxSchedules, CropTo, SimStep FROM " + ElementType);
            if (results.Count == 0)
            {
            ...
            CropTo = Convert.ToDouble(results[0]["CropTo"]);
